      ...
      <footer className="py-6 bg-gray-900 dark:bg-gray-900 relative z-10 border-t border-gray-800">
        <div className="container mx-auto px-4 text-center text-gray-400 dark:text-gray-400">
          <div className="flex justify-center space-x-6 mb-4">
            <a href="https://github.com/Juno-Cheng" className="text-gray-400 hover:text-purple-400 transition-colors">
              <GithubIcon />
            </a>
            <a href="https://www.linkedin.com/in/jodachen2021/" className="text-gray-400 hover:text-purple-400 transition-colors">
              <LinkedinIcon />
            </a>
            <a href="mailto:careercheng2021@gmail.com" className="text-gray-400 hover:text-purple-400 transition-colors">
              <MailIcon />
            </a>
          </div>
